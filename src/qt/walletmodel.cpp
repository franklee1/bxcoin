...
uint64_t WalletModel::getBalance() const
{
    return wallet->GetBalance();
}

uint64_t WalletModel::getUnconfirmedBalance() const
{
    return wallet->GetUnconfirmedBalance();
}

uint64_t WalletModel::getStake() const
{
    return wallet->GetStake();
}

uint64_t WalletModel::getImmatureBalance() const
{
...
{
    uint64_t newBalance = getBalance();
    uint64_t newStake = getStake();
    uint64_t newUnconfirmedBalance = getUnconfirmedBalance();
    uint64_t newImmatureBalance = getImmatureBalance();
